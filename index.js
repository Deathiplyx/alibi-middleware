...
app.post('/interrogate', async (req, res) => {
    ...
    try {
        ...
        const difficultyInstructions = {
            Easy: `Easy: Be very forgiving, patient, and helpful. Give the player plenty of chances to explain, offer hints, and avoid being aggressive. Only catch them if the evidence is overwhelming and contradictions are blatant.`,
        ...
        const catchInstruction = `If you catch the player in a lie or contradiction, ALWAYS explain in detail why you caught them. Reference the specific evidence, statements, and contradictions that led you to your conclusion. Make your reasoning clear and explicit so the player understands exactly what gave them away.`;
